...
//   const { userId, image, place, country, price, subtotal, gst, total } = req.body;
...
//   // Validate input data
//   if (!userId || !image || !place || !country || !price || !subtotal || !gst || !total) {
//     return res.status(400).json({ message: 'All fields are required' });
//   }

//   try {
//     // Create a new booking using the model, including userId
